...
def main():
    ...
    passwordEntry = tk.Entry(root, textvariable=password, show="*").grid(row=2, column=1)
    loginButton = tk.Button(root, text="Login", command=validateLogin).grid(row=4, column=0)
